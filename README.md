...
| `prove`        | `(scritto\|totale\|parziale\d\|orale(\d?)\|progetto(\d?))-\d{4}(-\d{2}-\d{2})?(-[a-z0-9]+)?-(testo\|soluzione)(-[a-z0-9]+)?\.[a-zA-Z0-9]+` | `parziale2-2022-05-24-testo-b.pdf`, `totale-2022-05-31-soluzione-incompleto.pdf`, `orale-2022-06-08-testo.md` |
